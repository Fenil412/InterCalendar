...
/**
 * SplashCursor — React Bits WebGL fluid simulation.
 * Renders a colourful fluid effect that follows the mouse.
 * Source: reactbits.dev / DavidHDev/react-bits
 * Only rendered on pointer devices (not touch-only).
 */
  ...
  useEffect(() => {
    ...
    function HSVtoRGB(h,s,v) {
      ...
      switch(i%6){case 0:r=v;g=t;b=p;break;case 1:r=q;g=v;b=p;break;case 2:r=p;g=v;b=t;break;
        case 3:r=p;g=q;b=v;break;case 4:r=t;g=p;b=v;break;case 5:r=v;g=p;b=q;break;default:break;}
      return {r,g,b};
    }
    function wrap(value,min,max) { const range=max-min; if(!range) return min; return ((value-min)%range)+min; }
    ...
    function handleMouseDown(e) {
      let p=pointers[0], posX=scaleByPixelRatio(e.clientX), posY=scaleByPixelRatio(e.clientY);
      updatePointerDownData(p,-1,posX,posY); clickSplat(p);
    }
    let firstMM=false;
    function handleMouseMove(e) {
      let p=pointers[0], posX=scaleByPixelRatio(e.clientX), posY=scaleByPixelRatio(e.clientY);
      if(!firstMM){updatePointerMoveData(p,posX,posY,generateColor());firstMM=true;}
